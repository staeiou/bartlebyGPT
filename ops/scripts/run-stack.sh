...
TELEMETRY_HISTORY_7D_BIN_SECONDS="${TELEMETRY_HISTORY_7D_BIN_SECONDS:-3600}"
TELEMETRY_HISTORY_CACHE_TTL_SECONDS="${TELEMETRY_HISTORY_CACHE_TTL_SECONDS:-600}"
TELEMETRY_HISTORY_DB_PATH="${TELEMETRY_HISTORY_DB_PATH:-}"
...
start_telemetry() {
  ...
  if [[ -n "${TELEMETRY_HISTORY_DB_PATH:-}" ]]; then
    "${SUDO[@]}" mkdir -p "$(dirname "${TELEMETRY_HISTORY_DB_PATH}")"
  fi
  ...
  local -a env_args=(
    ...
    "TELEMETRY_HISTORY_7D_BIN_SECONDS=${TELEMETRY_HISTORY_7D_BIN_SECONDS}"
    "TELEMETRY_HISTORY_CACHE_TTL_SECONDS=${TELEMETRY_HISTORY_CACHE_TTL_SECONDS}"
    "TELEMETRY_HISTORY_DB_PATH=${TELEMETRY_HISTORY_DB_PATH:-}"
    "TELEMETRY_VLLM_LOG_DIR=${TELEMETRY_VLLM_LOG_DIR:-}"
  )
