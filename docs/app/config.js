...
export const POWER_PROFILES = {
        "home-sd": {
          ...
          modalHtml: [
            ...
            `<p><strong>$/hr</strong> is the estimated electricity cost accrued continuously whether idle or busy, shared across all users of the site. It is computed based on SDG&amp;E residential rates.</p>`,
