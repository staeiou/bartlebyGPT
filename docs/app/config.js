...
export const POWER_PROFILES = {
        ...
        "home-sd": {
          ...
          modalHtml: [
            `<p>BartlebyGPT is a satire, but the cost data is genuine.</p>`,
            `<p>These figures reflect the live power consumption of BartlebyGPT's server (a ThinkStation P620 3955WX) which has one GPU (a Quadro RTX 4000). It currently runs in a residential home in San Diego, CA. The machine pulls ~120W at idle and up to ~300W when under full GPU load. This single GPU can generate around 10–15 replies in parallel at a time.</p>`,
            `<p><strong>Watts</strong> is the total measured power draw for that server from the AC outlet, which hosts all BartlebyGPT users combined. This does not include power used for the router and modem in the home. This does include the small air cooling fans for the server and GPU, which does emit a small amount of heat, but similar to a large TV, not an industrial data center. A small air conditioner window unit or TV with sound system pulls 400-600W, a fan pulls 50-75W, a MacBook Air streaming video pulls 20-30W, and an LED/CFL lightbulb pulls 10-15W.</p>`,
