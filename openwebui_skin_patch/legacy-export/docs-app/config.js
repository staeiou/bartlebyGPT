...
export const POWER_PROFILES = {
        ...
        "pi-rpi4": {
          ...
          modalHtml: [
            ...
            `<p><strong>gCO₂/hr</strong> is estimated carbon emissions per hour from the current power draw: watts × grid carbon intensity. It uses the <strong>gCO₂/Wh</strong> value shown in <em>Advanced</em> (default 0.200), and you can change that value for your local grid.</p>`,
